...
**data** | [**SubSpecializationDtoPagedList**](SubSpecializationDtoPagedList.md) |  | [optional] [default to undefined]

## Example

```typescript
import { SubSpecializationDtoPagedListResponse } from './api';

const instance: SubSpecializationDtoPagedListResponse = {
    httpStatusCode,
    succeeded,
    message,
    errors,
