...
**data** | [**EducationBriefDtoPagedList**](EducationBriefDtoPagedList.md) |  | [optional] [default to undefined]

## Example

```typescript
import { EducationBriefDtoPagedListResponse } from './api';

const instance: EducationBriefDtoPagedListResponse = {
    httpStatusCode,
    succeeded,
    message,
    errors,
