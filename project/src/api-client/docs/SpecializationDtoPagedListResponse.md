...
**data** | [**SpecializationDtoPagedList**](SpecializationDtoPagedList.md) |  | [optional] [default to undefined]

## Example

```typescript
import { SpecializationDtoPagedListResponse } from './api';

const instance: SpecializationDtoPagedListResponse = {
    httpStatusCode,
    succeeded,
    message,
    errors,
