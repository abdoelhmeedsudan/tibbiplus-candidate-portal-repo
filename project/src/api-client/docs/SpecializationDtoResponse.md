...
**data** | [**SpecializationDto**](SpecializationDto.md) |  | [optional] [default to undefined]

## Example

```typescript
import { SpecializationDtoResponse } from './api';

const instance: SpecializationDtoResponse = {
    httpStatusCode,
    succeeded,
    message,
    errors,
