...
**data** | [**CityDtoPagedList**](CityDtoPagedList.md) |  | [optional] [default to undefined]

## Example

```typescript
import { CityDtoPagedListResponse } from './api';

const instance: CityDtoPagedListResponse = {
    httpStatusCode,
    succeeded,
    message,
    errors,
