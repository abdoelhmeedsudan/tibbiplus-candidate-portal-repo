...
**data** | [**SubSpecializationDto**](SubSpecializationDto.md) |  | [optional] [default to undefined]

## Example

```typescript
import { SubSpecializationDtoResponse } from './api';

const instance: SubSpecializationDtoResponse = {
    httpStatusCode,
    succeeded,
    message,
    errors,
