...
**data** | [**NationalityDtoPagedList**](NationalityDtoPagedList.md) |  | [optional] [default to undefined]

## Example

```typescript
import { NationalityDtoPagedListResponse } from './api';

const instance: NationalityDtoPagedListResponse = {
    httpStatusCode,
    succeeded,
    message,
    errors,
