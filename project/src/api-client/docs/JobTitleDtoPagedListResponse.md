...
**data** | [**JobTitleDtoPagedList**](JobTitleDtoPagedList.md) |  | [optional] [default to undefined]

## Example

```typescript
import { JobTitleDtoPagedListResponse } from './api';

const instance: JobTitleDtoPagedListResponse = {
    httpStatusCode,
    succeeded,
    message,
    errors,
