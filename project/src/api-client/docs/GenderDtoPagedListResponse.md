...
**data** | [**GenderDtoPagedList**](GenderDtoPagedList.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GenderDtoPagedListResponse } from './api';

const instance: GenderDtoPagedListResponse = {
    httpStatusCode,
    succeeded,
    message,
    errors,
