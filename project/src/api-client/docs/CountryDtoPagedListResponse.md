...
**data** | [**CountryDtoPagedList**](CountryDtoPagedList.md) |  | [optional] [default to undefined]

## Example

```typescript
import { CountryDtoPagedListResponse } from './api';

const instance: CountryDtoPagedListResponse = {
    httpStatusCode,
    succeeded,
    message,
    errors,
