...
**data** | [**MaritalStatusDtoPagedList**](MaritalStatusDtoPagedList.md) |  | [optional] [default to undefined]

## Example

```typescript
import { MaritalStatusDtoPagedListResponse } from './api';

const instance: MaritalStatusDtoPagedListResponse = {
    httpStatusCode,
    succeeded,
    message,
    errors,
