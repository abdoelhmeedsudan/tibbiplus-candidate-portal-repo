...
**data** | [**EducationBriefDto**](EducationBriefDto.md) |  | [optional] [default to undefined]

## Example

```typescript
import { EducationBriefDtoResponse } from './api';

const instance: EducationBriefDtoResponse = {
    httpStatusCode,
    succeeded,
    message,
    errors,
